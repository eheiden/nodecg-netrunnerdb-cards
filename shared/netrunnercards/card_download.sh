...
curl -g "https://api.netrunnerdb.com/api/v3/public/printings?fields[printings]=stripped_title&images&page[size]=3000" | json > cards.json.temp
...
for URL in $(curl -g "https://api.netrunnerdb.com/api/v3/public/printings?fields[printings]=images&page[size]=3000" | jq '.data[].attributes.images.nrdb_classic.large' | sed -e 's/"//g');
